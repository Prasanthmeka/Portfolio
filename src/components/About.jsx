  ...
  return (
    <section id="about" className="py-20 md:py-32 relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ThreeDTilt maxTilt={6}>
              <div className="glass-card rounded-2xl p-6 md:p-8 h-full">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  I am a <span className="text-cyan-400 font-medium">Software Development Engineer</span> specializing in the React ecosystem to build high-impact, responsive UI features for enterprise platforms. I have hands-on experience in full-stack Java development, designing SQL databases, and developing robust APIs.
                </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 reveal-right">
            {attributes.map((attr, idx) => {
              ...
              return (
                <ThreeDTilt key={attr.title} maxTilt={10} className="h-full rounded-2xl overflow-hidden">
                  <div
                    className="glass-card rounded-2xl p-6 h-full group hover:bg-white/5 transition-all duration-300 border border-white/5 hover:border-cyan-400/30"
        ...
        <div className="mt-12 md:mt-16 reveal-scale">
